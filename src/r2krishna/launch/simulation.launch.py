    ...
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=[
                ...
                '/belly_camera/camera_info@sensor_msgs/msg/CameraInfo@gz.msgs.CameraInfo',
                '/tof_low_left@sensor_msgs/msg/LaserScan@gz.msgs.LaserScan',
                '/tof_low_right@sensor_msgs/msg/LaserScan@gz.msgs.LaserScan',
                '/tof_high_left@sensor_msgs/msg/LaserScan@gz.msgs.LaserScan',
                '/tof_high_right@sensor_msgs/msg/LaserScan@gz.msgs.LaserScan',
